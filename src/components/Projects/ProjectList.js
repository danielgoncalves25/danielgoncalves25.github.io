...
const allProjects = [
  {
    ...
    desc: "This is a mobile Clash of Clans App that allows users to search for other's Clash of Clans profile using their player tag provided in game. This is possible using the Clash of Clans API. I am still currently working on this project and plan on adding more useful features soon.",
    imgPath: coc,
  ...
  },
  {
    ...
    desc: "This is an app that keeps track of recent transations made. Users can input the amount and transaction summary. There is a chart that displays that amount spent throughtout the last week.",
    imgPath: expense,
  ...
  {
    name: "Movie Searcher",
    desc: "This is an web application that allows users to view which movies are recently trending and search for their favorite movies.",
    imgPath: movie,
  ...
  },
  {
    ...
    desc: "Allows users to shop, and add shoes to cart for checkout. Users will be required to login or register before shopping. Mobile application built using Flutter, Firebase, and Sneaker Database API.",
    imgPath: shoes,
    url: "https://github.com/danielgoncalves25/shoes-shop",
    liveUrl: null,
    images: [<SiFlutter size="2rem" />, <SiFirebase size="2rem" />],
  },
  {
    name: "Zoom Automation",
    desc: "A simple automation script to join a zoom meeting. This was built using Python and Selenium.",
    imgPath: zoom,
